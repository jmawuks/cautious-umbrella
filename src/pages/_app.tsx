  ...
  return (
    <Fragment>
      <Head>
        ...
        />
        <title key="title">Locker</title>

        <meta key="description" name="description" content="Locker" />

        <meta name="application-name" content="Locker" />
        ...
        <meta key="twitter:title" name="twitter:title" content="Locker" />
        <meta key="twitter:url" name="twitter:url" content="https://solarbeam.io" />
        <meta key="twitter:description" name="twitter:description" content="Locker" />
        ...
        <meta key="og:site_name" property="og:site_name" content="Locker" />
        ...
        <meta key="og:description" property="og:description" content="Locker" />
      </Head>
